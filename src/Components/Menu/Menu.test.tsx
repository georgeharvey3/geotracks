...
describe('Menu', () => {
  it('renders all three buttons', () => {
    render(
      <Menu gameModes={gameModes} setGameMode={vi.fn()} setShowScoreboard={vi.fn()} />
    );
  ...
  it('calls setGameMode with competition when Competition button clicked', async () => {
    ...
    render(
      <Menu gameModes={gameModes} setGameMode={setGameMode} setShowScoreboard={vi.fn()} />
    );
  ...
  it('calls setShowScoreboard when Scoreboard button clicked', async () => {
    ...
    render(
      <Menu gameModes={gameModes} setGameMode={vi.fn()} setShowScoreboard={setShowScoreboard} />
    );
